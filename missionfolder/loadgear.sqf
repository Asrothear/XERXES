...
switch (_class) do {
	...
	{ 
		...
		player addPrimaryWeaponItem "30Rnd_556x45_Stanag_Sand_green";
		...
		for "_i" from 1 to 9 do {player addItemToVest "30Rnd_556x45_Stanag_Sand_green";};
	...
	case 3:
	{
		...
		for "_i" from 1 to 3 do {player addItemToVest "SmokeShellRed";};
		for "_i" from 1 to 3 do {player addItemToVest "SmokeShellGreen";};
		for "_i" from 1 to 10 do {player addItemToVest "30Rnd_556x45_Stanag_Sand_green";};
	...
	case 4:
	{
		...
		for "_i" from 1 to 5 do {player addItemToVest "30Rnd_556x45_Stanag_Sand_green";};
		for "_i" from 1 to 3 do {player addItemToVest "B_IR_Grenade";};
		...
		for "_i" from 1 to 5 do {player addItemToBackpack "ACE_tourniquet";};
		for "_i" from 1 to 5 do {player addItemToBackpack "ACE_quikclot";};
		for "_i" from 1 to 5 do {player addItemToBackpack "30Rnd_556x45_Stanag_Sand_green";};
